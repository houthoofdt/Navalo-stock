    ...
    if (index >= 0) {
        ...
        if (storage.getMode() === 'googlesheets') {
            try {
                ...
                console.log('✅ Order confirmed in Google Sheets:', id);
            } catch (e) {
                console.warn('Failed to sync order confirmation to Google Sheets:', e);
            }
        }
    ...
    if (index >= 0) {
        ...
        if (storage.getMode() === 'googlesheets') {
            try {
                ...
                console.log('✅ Order marked delivered in Google Sheets:', id);
            } catch (e) {
                console.warn('Failed to sync delivery status to Google Sheets:', e);
            }
        }
