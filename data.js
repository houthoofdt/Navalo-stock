...
function getComponentPrice(ref, currency) {
    ...
    if (typeof loadedComponentPrices !== 'undefined' && loadedComponentPrices[ref]) {
        ...
        if (currency === 'EUR') {
            return loaded.eur || loaded.priceEur || null;
        } else if (currency === 'CZK') {
            return loaded.czk || loaded.priceCzk || null;
        }
        return loaded.eur || loaded.priceEur || loaded.czk || loaded.priceCzk || null;
    }
